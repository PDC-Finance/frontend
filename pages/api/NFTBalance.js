...
const fetchTransactions = async (reqBody) => {
  const url = `https://api.covalenthq.com/v1/80001/address/${reqBody.walletAddress}/balances_v2/?quote-currency=USD&format=JSON&nft=true&no-nft-fetch=false&key=${process.env.COVALENT_API_KEY}`;
  try {
