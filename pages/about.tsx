      ...
      <section className="text-gray-600 body-font my-10 h-3/5">
        ...
        <div className="container mx-auto flex px-5 py-24 md:flex-row flex-col items-center">
          ...
          <div className="lg:max-w-lg lg:w-full md:w-1/2 w-5/6">
            <Image width={800} height={500} className="object-cover object-center rounded" alt="hero" src="/team.svg" />
          </div>
        </div>
      </section>
                ...
                <div className="md:flex-grow">
                  ...
                  <ul className="list-disc ml-10">
                    ...
                    <li>
                      ...
                      15th Dec 2022) to make the payment to the Receiver from the payer PDC Finances wallet. The payer need not hold the necessary
            ...
            <div className="p-4 lg:w-1/2 md:w-1/2">
              <div className="h-full flex flex-col items-center text-center">
                <Image
                  ...
                  width={200}
                  height={200}
                  className="flex-shrink-0 rounded-full  object-cover object-center mb-4"
